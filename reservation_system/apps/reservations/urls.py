...
urlpatterns = [
    ...
    path('reservationConfirmation/', ReservationCreateView.as_view(), name='res-create'),
    path('reservation/<str:confirmation_number>/', ReservationDetailView.as_view(), name='res-detail'),
